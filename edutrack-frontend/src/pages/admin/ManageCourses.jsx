      ...
      <div className={styles.content}>
        <div className={styles.header}>
          <div>
            ...
            <p className={styles.subtitle}>{courses.length} curso{(courses.length !== 1) ? 's' : ''} en total</p>
          </div>
            ...
            <div className={styles.table}>
              ...
              {courses.map((course) => (
                <div key={course.id} className={styles.tableRow}>
                  ...
                  <span className={styles.colLessons}>
                    {course.lessonCount}
                  </span>
        ...
        {totalPages > 1 && (
          <div className={styles.pagination}>
            <button className={styles.pageBtn} disabled={page === 0} onClick={() => fetchCourses(page - 1)}>
              Anterior
            </button>
            <span className={styles.pageInfo}>Página {page + 1} de {totalPages}</span>
            <button className={styles.pageBtn} disabled={page >= totalPages - 1} onClick={() => fetchCourses(page + 1)}>
              Siguiente
            </button>
          </div>
        )}
